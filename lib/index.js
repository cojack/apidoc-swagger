var _ = require('lodash'),
	apidoc = require('apidoc-core'),
	winston = require('winston'),
	path = require('path'),
	markdown = require('marked'),
	fs = require('fs-extra'),
	PackageInfo = require('./apidoc/swagger/PackageInfo');

var Swagger = require('./apidoc/swagger/Swagger');
...
function createApidocSwagger(options) {
	...
	try {
		...
		if (app.options.parse !== true) {
			...
			var swagger = new Swagger(projectData);
			api.swaggerData = JSON.stringify(swagger.parse(apidocData));
